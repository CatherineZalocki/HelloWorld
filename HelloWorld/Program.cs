...
namespace HelloWorld
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ////Console.WriteLine(heightOne - heightTwo); //sub ex
            ////Console.WriteLine(weightOne * weightTwo); //multi ex
            ...
            //////part six mathematical operator ex
            ////Console.WriteLine(ageOne + ageTwo);
            ...
            //part seven increment and decrement operator ex 
            //ageTwo = ageTwo + 1;
            ...
            ////Part eight concatnation example
            //Console.WriteLine(messageOne + " " + messageTwo + ".");

            //Console.WriteLine("I am " + ageOne + " and yes  it is " + isGodLikeOne + " that I am God like.");
            ...
            // //Console.WriteLine("I am {0} years old, and yes it is {1} I am godlike,", ageOne, isGodLikeOne);
            // //Console.WriteLine("I weigh around {0} pounds, and I an around {1} inches tall.");

            // ////Part nine string equality ex
            ...
            ////may need to remove the word string from string rank and int from int age, below if running program including above info  
